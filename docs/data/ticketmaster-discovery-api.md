...
| Fields taken | Event id, name, attractions, venue name/city/state/time zone, local and UTC start, date/time-TBD flags, event URL. Price ranges are read but not shown (DECISIONS 0013). Nothing about any person. |
